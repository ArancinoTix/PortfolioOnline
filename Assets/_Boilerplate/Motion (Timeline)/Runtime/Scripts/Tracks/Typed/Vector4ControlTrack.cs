...
namespace U9.Motion.Timeline.TypedTrack
{
    ...
    public class Vector4ControlTrack : TrackAsset
    {
        [Tooltip("The parameter the clips in this track should manipulate")]
        [SerializeField] private string m_ParameterName;

        Vector4ControlMixer m_Mixer;

        public override Playable CreateTrackMixer(PlayableGraph graph, GameObject go, int inputCount)
        {
            var mixer = ScriptPlayable<Vector4ControlMixer>.Create(graph, inputCount);
        ...
        {
            clip.displayName = "Four Axis Clip";
