...
{
    public class Vector3ControlMixer : TypedMotionControlMixer<Vector3>
    {
        public override void ProcessFrame(Playable playable, FrameData info, object playerData)
        {
            ...
            if (component != null && parameterName != null)
            {
                if (!firstFrameHappened)
                {
                    ...
                    {
                        defaultValue = (Vector3)pInfo.GetValue(component);
                    }
        ...
        {
            return new Vector3(behaviour.xEnabled ? Mathf.Lerp(behaviour.startAt.x, behaviour.endAt.x, behaviour.curveX.Evaluate(normalizedTime)) : defaultValue.x,
