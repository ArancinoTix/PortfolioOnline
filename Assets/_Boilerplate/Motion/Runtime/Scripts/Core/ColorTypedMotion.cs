...
namespace U9.Motion
{
    public abstract class ColourTypedMotion<T, T2> : BaseMotion where T : Component
    {
        ...
        [ColorUsage(true, true)] public T2 StartAt = default;
        [Tooltip("Designated value to represent what the Curves Y = 1 equates to")]
        [ColorUsage(true, true)] public T2 EndAt = default;
